...
class PageAudit
{
     ...
     */
    private const MODEL_OWNED = ['placeholder', 'broken-image', 'script-error', 'console-error', 'dash', 'competitor-named', 'price-unmarked', 'claim-invented', 'layout-dropped', 'number-reworded', 'label-language', 'personal-data'];
