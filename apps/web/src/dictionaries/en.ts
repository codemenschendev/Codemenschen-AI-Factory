export const en = {
  ...
  how: {
    ...
    title: "From idea to online in four simple steps.",
    cta: "See the app ideas →",
    steps: [
      { h: "Describe your idea", p: "One sentence is enough: website, app, ads or e-mails." },
      { h: "See the free preview", p: "Appwerk AI builds a clickable preview in a few minutes. It costs nothing." },
      { h: "Approve scope and fixed price", p: "You see what you get and what it costs before you pay a cent." },
      { h: "Launch, advertise, measure", p: "Your project goes live. Ads start only when you press start." },
    ],
  },
  split: {
  ...
  home: {
    eyebrow: "Everything from one hand",
    titleA: "Your business online.",
    titleB: "Website, app and ads",
    titleC: "from one hand.",
    lede: "Describe your idea. Appwerk AI builds a free preview in minutes. You see the fixed price before you pay, and our team checks every paid project.",
    cta: "Get a free preview",
    cta2: "See prices",
    art: {
      period: "Last 30 days",
    ...
    services: {
      ...
      lede: "Choose one service or the complete package. Each one starts with a free preview.",
      from: "From",
      fixed: "Fixed price",
    ...
    campaign: {
      ...
      offerExample: "“Pre-order bread and pastries online, bakery in Linz”",
  ...
  checkout: {
    ...
    site: {
      development: "Website (one page)",
      hosting: "Hosting and care",
      hostingIncluded: "First {months} months included, then {eur}/month",
      step3: "3 · Go-live and withdrawal",
      waiverLabel: "I expressly request that my website goes live immediately, and I acknowledge that I lose my right of withdrawal once it is live.",
      waiverOff: "Without this consent your website goes live after the 14-day withdrawal period. Your withdrawal right stays fully intact.",
      included: ["The page as you saw it, live at its own address", "Your own domain, connected by our team", "Sign-up or contact form, delivered to your inbox", "SSL, hosting and care for the first year", "One change included, more on request"],
  ...
  success: {
    ...
    site: "Your website is going live now. You'll get an e-mail with its address and a sign-in link to your dashboard, where you can enter your own domain.",
  ...
  project: {
    site: {
      ...
      domainHint: "Enter the domain your website should use, for example baeckerei-lang.at. Our team connects it within one working day.",
      domainLabel: "Domain",
      domainSave: "Request domain",
      domainSaved: "Requested on {date}. We connect it and let you know.",
      domainDns: "Set this A record at your domain provider so the domain reaches our server:",
      domainRemove: "Remove",
      domainInvalid: "That is not a domain. Enter it like example.at.",
      changesTitle: "Changes",
      changesHint: "One change is included, right on the preview page. For further changes, reply to your order e-mail or write to us.",
      changesOpen: "Open the preview page",
      hostingTitle: "Hosting",
      hostingHint: "The first {months} months are included. After that hosting costs {eur}/month; we tell you in good time.",
      signups: "Sign-ups",
      signupsHint: "People who filled in the form on your page. Each one confirmed by e-mail.",
      imprintTitle: "Impressum (legal notice)",
      imprintMissing: "Required: in Austria and Germany every business website must name who runs it. Fill in the fields below. Your page links the Impressum as soon as it is complete.",
      imprintDone: "Your Impressum is online and linked in the footer of your page.",
      imprintOpen: "View Impressum ↗",
      imprintHint: "Fields marked * are needed by every business. Add the others if they apply to you, for example the VAT ID or the company register.",
      imprintSave: "Save Impressum",
      imprintSaved: "Saved.",
      imprintInvalid: "Please check the marked fields.",
      imprintFields: {
        name: "Business name *",
        owner: "Owner or managing director",
        trade: "Business activity, for example bakery",
        street: "Street and number *",
        zip_city: "Postcode and town *",
        country: "Country *",
        email: "E-mail *",
        phone: "Phone",
        vat_id: "VAT ID (UID)",
        register: "Company register number and court",
        chamber: "Chamber or professional body, for example WKO",
        authority: "Supervisory authority, for example the district authority",
  ...
  admin: {
    ...
    conversions: {
      ...
      fields: {
        ...
        google_conversion_goal: "Google goal for Appwerk campaigns",
      },
    ...
    traffic: {
      ...
      visits: "Visits on our site",
      visitsLegend: "Visits on our site",
      perDay: "Per day",
      clicksN: "{n} clicks",
      visitsN: "{n} visits",
      range: "{a} to {b}",
      ...
      keyword: "Keyword",
      quality: "Quality",
      kwStatus: { paused: "paused", removed: "removed" },
      searchTerms: "What people searched for",
      searchTermsHint: "The real searches the ad showed for. If one does not fit, exclude it.",
      searchTerm: "Search",
      exclude: "Exclude",
      excludedShort: "noted",
      isExcluded: "excluded",
      excludedNote: "Noted as a negative. Send it with Apply to Google on the keyword screen.",
      devices: "Devices",
      device: { mobile: "Phone", desktop: "Computer", tablet: "Tablet", connected_tv: "TV", other: "Other" },
      countries: "Countries",
      hours: "Clicks by hour",
      none: "No data in this period yet.",
      show: "Traffic",
      hide: "Hide traffic",
    },
    ownAds: {
      intro: "Advertising for Appwerk itself, on our own accounts and paid by us: Google search, or Facebook and Instagram through Meta. The steps: write the campaign, add its keywords (Google) or its picture (Meta), send it paused, then start it.",
      googleMissing: "Google Ads is not set up on the server. Drafts work, sending does not yet.",
      killed: "The kill switch is on. No campaign can start.",
      kpiCampaigns: "Campaigns",
      kpiRunning: "Running now",
      kpiPerDay: "{eur} a day",
      kpiToday: "Spent today",
      kpiTotal: "Spent in total",
      kpiLimits: "Daily limit, all ads",
      kpiLimitsSub: "at most {eur} per campaign",
      create: "New campaign",
      campaign: "Campaign",
      state: "Status",
      perDay: "Per day",
      ...
      open: "View",
      close: "Close",
      empty: "No campaign of our own yet. Create the first one with New campaign.",
      newTitle: "New campaign",
      readOnly: "This campaign is on Google. Its text can no longer change here. Its keywords can, on the keyword screen.",
      name: "Name",
      namePlaceholder: "for example Websites for businesses AT",
      language: "Ad language",
      countries: "Countries",
      landing: "Landing page",
      landingHint: "Where a click goes. https only.",
      message: "What it is about",
      messagePlaceholder: "What Appwerk offers, for whom, and what the reader gets.",
      audience: "For whom",
      audiencePlaceholder: "for example small businesses without their own IT",
      offer: "Offer",
      offerPlaceholder: "for example a free draft, then a fixed price",
      daily: "Budget per day (€)",
      dailyHint: "What the platform may spend in one day.",
      cap: "Total budget (€)",
      capHint: "When it is reached, the guard stops the campaign. At most {eur}.",
      ends: "Ends on",
      endsHint: "Leave empty for no end date.",
      adText: "Ad text",
      write: "Write with Appwerk AI",
      writing: "Writing…",
      headlines: "Headlines ({n} of 15)",
      headlinesHint: "One per line, 30 characters each at most. At least 3, better 10 or more.",
      descriptions: "Descriptions ({n} of 4)",
      descriptionsHint: "One per line, 90 characters each at most. At least 2.",
      save: "Save",
      saved: "Saved.",
      written: "Appwerk AI wrote a draft. Read it, change what does not fit, and save.",
      confirmReplace: "Replace the ad text with a new draft?",
      publish: "Send to Google, paused",
      publishHint: "Sending creates the campaign on Google, paused. That costs nothing. Money only moves after Start.",
      publishing: "On its way to Google. This usually takes less than a minute.",
      toKeywords: "Choose keywords",
      remove: "Delete",
      confirmDelete: "Delete the draft \"{name}\"?",
      confirmStart: "Start \"{name}\"? Real money is spent from now on: up to {day} a day, {eur} in total at most.",
      results: "Results",
      resultShort: "{q} quotes · {o} orders",
      perOrder: "{eur} per order",
      visitsN: "{n} visits",
      steps: { clicks: "Clicks on Google", visits: "Visits", interest: "Interest", quotes: "Quotes", orders: "Paid" },
      each: "{eur} each",
      revenue: "Revenue",
      spentOf: "spent {eur}",
      funnelHint: "Clicks and cost come from the platform. Visits to orders are counted by our own cookieless analytics: same person, same day. Somebody who clicks today and buys tomorrow is missing here, so the numbers run low rather than high.",
      finalUrl: "A click lands on",
      goalMissing: "Counts on the account goals, not the Appwerk goal",
      tooLong: "A line is too long (marked red). Shorten it, then save.",
      unsaved: "There are unsaved changes. Save first, then send.",
      ready: "Everything is there. The campaign can go to Google.",
      before: "Still missing before sending:",
      needHeadlines: "at least 3 headlines (now {n})",
      needDescriptions: "at least 2 descriptions (now {n})",
      needKeywords: "at least one approved keyword",
      metaMissing: "Meta is not set up yet (token, ad account, page). Drafts work, sending to Meta does not yet.",
      platform: "Where it runs",
      platformGoogle: "Google search",
      platformMeta: "Facebook and Instagram",
      platformFixed: "The platform is chosen when the campaign is created.",
      readOnlyMeta: "This campaign is on Meta. Its text and picture can no longer change here.",
      headlinesHintMeta: "The line under the picture, 40 characters at most. Meta runs the first one.",
      descriptionsMeta: "Ad text ({n})",
      descriptionsHintMeta: "The text above the picture. Meta runs the first one. Under 125 characters reads best.",
      publishMeta: "Send to Meta, paused",
      publishHintMeta: "Sending creates the campaign on Meta, paused. That costs nothing. Money only moves after Start.",
      publishingMeta: "On its way to Meta. This usually takes less than a minute.",
      readyMeta: "Everything is there. The campaign can go to Meta.",
      clicksMeta: "Clicks on Meta",
      image: "Picture",
      imageHint: "JPG or PNG, square, 1080 × 1080 pixels is best (600 at least). A picture with little or no text runs best.",
      imageUpload: "Upload picture",
      imageReplace: "Replace picture",
      imageUploading: "Uploading…",
      imageNone: "No picture yet.",
      imageSaveFirst: "Save the campaign first, then add its picture.",
      needHeadline: "a headline",
      needText: "an ad text",
      needImage: "a picture",
    },
    clientAds: {
      intro: "Every client's ad accounts and campaigns. Appwerk's own advertising is not in here: that is our money and has its own screen. What needs somebody is at the top.",
      kpiClients: "Clients with ads",
      kpiCampaigns: "Campaigns: {n}",
      kpiRunning: "Running now",
      kpiToday: "Spent today",
      kpiTotal: "Spent in total",
      kpiAccounts: "Connected accounts",
      kpiAccountsSub: "{p} waiting, {r} declined",
      kpiProblems: "Problems",
      search: "Search client or project",
      filter: "Filter",
      filters: { all: "All", running: "Running", problems: "Problems", waiting: "Waiting for client" },
      client: "Client",
      ...
      total: "Total",
      problems: "Problems",
      problemsN: "{n} to check",
      open: "Open",
      close: "Close",
      noAccount: "none",
      noAccountLong: "This client has not connected an ad account. Their campaigns run on Appwerk's account.",
      noCampaigns: "No campaign yet.",
      empty: "No client has connected an account or started a campaign yet.",
      noMatch: "Nothing matches this filter.",
      detailSummary: "Campaigns {n} · running {r} · spent {eur}",
      platform: "Platform",
      number: "Number",
      name: "Name",
      state: "Status",
      ...
      campaign: "Campaign",
      runsOn: "Runs on",
      runsClient: "Client's account",
      runsAppwerk: "Appwerk's account",
      budget: "Budget",
      perMonth: "a month",
      spent: "Spent",
      todayShort: "today",
      ...
      pause: "Pause",
      start: "Start",
      confirmStart: "Start \"{name}\"? From now on it spends real money, up to {eur}.",
      status: { draft: "draft", publishing: "publishing", paused: "paused", active: "running", failed: "failed", ended: "ended" },
      problemText: {
        publish_failed: "Publishing failed.",
        spend_stale: "Spend not checked for over an hour.",
        over_total: "Running at or over its total.",
        account_refused: "The client declined the connection.",
        account_removed: "The client cut the connection.",
        account_error: "The platform refused the last check.",
        meta_no_page: "No Facebook page, so no ad can run on this account.",
      },
      accountStatus: { pending: "waiting", active: "connected", refused: "declined", removed: "disconnected" },
    },
    keywords: {
      title: "Keywords",
      ...
      notOnGoogleH: "Not on Google yet",
      notOnGoogleP: "Nothing here has reached Google. Keywords you keep are saved and go to Google together with the campaign when it is published. Nothing is spent before that.",
      stepsH: "How to get them live",
      steps: ["Keep the keywords you want, remove the rest.", "Publish the campaign (Appwerk campaigns or Client ads).", "Come back here: every kept keyword shows live on Google."],
      onGoogleH: "On Google",
      onGoogleId: "Google campaign ID {id}. In Google Ads: Campaigns, open it, then Keywords.",
      toSend: "{n} kept but not sent yet. Press Apply to Google.",
      allSent: "Everything you kept is live on Google.",
      keepAll: "Keep all {n}",
      publishFirst: "Publish the campaign first",
      sumLive: "live on Google",
      sumApproved: "kept, not sent",
      sumWaiting: "waiting for you",
      sumPaused: "taken out",
    },
    consoleName: "Console",
    ...
    twoFactor: {
      ...
      verifyText: "Enter the 6-digit code from your authenticator app.",
      verify: "Continue",
      codeLabel: "Code",
      wrong: "That code does not match. Check the time on your phone and use the next code.",
      tooMany: "Too many tries. Wait a minute.",
      failed: "Setup could not start. Reload the page.",
    ...
    signInPrompt: "Enter your e-mail. We send a link that brings you straight back here.",
    signInSend: "Send sign-in link",
    signInSentTitle: "Check your inbox",
    signInSent: "If {email} has access, a link is on its way. It is valid for 30 minutes.",
    signInAgain: "Use another address",
    signInFailed: "Too many tries. Wait a minute and send again.",
    signOut: "Sign out",
    ...
    imageKeyTile: "Paid renders: OpenAI key",
    imageKeySet: "Key set",
    imageKeyNone: "No key",
    imageKeyHint: "Pictures for paying customers are rendered on this key through the OpenAI API. Without a key they use the server's image service as before. Free prototypes always stay on Codex.",
    imageKeyBy: "set by",
    imageKeyPlaceholder: "sk-…",
    imageKeySave: "Check and save",
    imageKeyReplace: "Replace key",
    imageKeyRemove: "Remove key",
    imageKeyRemoveConfirm: "Remove the key? Paid renders then use the server's image service again.",
  ...
  account: {
    ...
    total: "Order total",
    logout: "Sign out",
    protos: "Your prototypes",
    protosEmpty: "No prototype yet.",
    protoNew: "Start a new prototype",
    protoState: { queued: "being built", building: "being built", ready: "ready", failed: "did not work", expired: "expired" } as Record<string, string>,
    protoBought: "bought",
    hello: "Your account",
    signInTitle: "Sign in",
    signInLead: "Enter your e-mail. We send you a link, no password needed.",
    emailLabel: "E-mail",
    projects: "Your projects",
    projectsEmpty: "No project yet. Any prototype becomes a real project at a fixed price in one click.",
    seePrices: "See prices",
    open: "Open",
    projectState: { PAID: "paid", SPECIFICATION: "in progress", BUILDING: "in progress", TESTING: "in progress", FIXING: "in progress", REVIEW: "preview ready", READY: "ready", PUBLISHED: "live", live: "live", FAILED: "we are on it" } as Record<string, string>,
  },
  adAccounts: {
  ...
  proto: {
    ...
    boughtSite: "This website has been bought and is live.",
    openLive: "Open the live site ↗",
    makeReal: {
      site: "Turn it into a web app instead",
    ...
    mineHint: "Kept on this device. Signed in, you find all of them under My projects.",
  ...
  security: {
    ...
    retention: [
      ...
      ["Backups", "90 days"],
      ["Log of changes in the admin console", "12 months"],
