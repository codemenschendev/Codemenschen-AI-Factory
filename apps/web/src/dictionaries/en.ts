export const en = {
  ...
  admin: {
    ...
    ownAds: {
      intro: "Advertising for Appwerk itself: Google search campaigns on our own account, paid by us. The steps: write the campaign, choose its keywords, send it to Google paused, then start it.",
      ...
      dailyHint: "What Google may spend in one day.",
      cap: "Total budget (€)",
      ...
      revenue: "Revenue",
      spentOf: "spent {eur}",
      funnelHint: "Clicks and cost come from Google. Visits to orders are counted by our own cookieless analytics: same person, same day. Somebody who clicks today and buys tomorrow is missing here, so the numbers run low rather than high.",
