export const de = {
  ...
  account: {
    ...
    total: "Bestellsumme",
    logout: "Abmelden",
    protos: "Deine Prototypen",
    protosEmpty: "Noch kein Prototyp.",
    protoNew: "Neuen Prototyp starten",
    protoState: { queued: "wird gebaut", building: "wird gebaut", ready: "fertig", failed: "nicht geklappt", expired: "abgelaufen" } as Record<string, string>,
    protoBought: "gekauft",
    hello: "Dein Konto",
    signInTitle: "Anmelden",
    signInLead: "Gib deine E-Mail ein. Wir schicken dir einen Link, ein Passwort brauchst du nicht.",
    emailLabel: "E-Mail",
    projects: "Deine Projekte",
    projectsEmpty: "Noch kein Projekt. Aus jedem Prototyp wird mit einem Klick ein echtes Projekt mit Festpreis.",
    seePrices: "Preise ansehen",
    open: "Öffnen",
    projectState: { PAID: "bezahlt", SPECIFICATION: "in Arbeit", BUILDING: "in Arbeit", TESTING: "in Arbeit", FIXING: "in Arbeit", REVIEW: "Vorschau bereit", READY: "fertig", PUBLISHED: "online", live: "online", FAILED: "wir kümmern uns" } as Record<string, string>,
  },
  adAccounts: {
  ...
  proto: {
    ...
    mineHint: "Auf diesem Gerät gespeichert. Angemeldet findest du alle unter Meine Projekte.",
