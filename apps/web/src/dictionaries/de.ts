export const de = {
  ...
  admin: {
    ...
    ownAds: {
      intro: "Werbung für Appwerk selbst: Google Suchkampagnen auf unserem eigenen Konto, bezahlt von uns. Der Ablauf: Kampagne schreiben, Keywords wählen, pausiert zu Google senden, dann starten.",
      ...
      dailyHint: "So viel darf Google an einem Tag ausgeben.",
      cap: "Gesamtbudget (€)",
      ...
      funnelHint: "Klicks und Kosten kommen von Google. Besuche bis Aufträge zählt unsere eigene Analyse ohne Cookies: gleiche Person, gleicher Tag. Wer heute klickt und morgen kauft, fehlt hier. Die Zahlen sind also eher zu niedrig als zu hoch.",
