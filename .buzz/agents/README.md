...
| File | Agent | Model |
|---|---|---|
| appwerk-product.md | Appwerk Product AI | Sonnet |
| appwerk-marketing.md | Appwerk Marketing AI | Sonnet |
| appwerk-dev.md | Appwerk Dev AI | Opus |

How to change an agent:

- In the channel: `@Appwerk Dev AI update the Marketing instructions: ...`
